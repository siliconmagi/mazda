...
var vec__43119_43122 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_43123 = cljs.core.nth.call(null,vec__43119_43122,(0),null);
var only_after_43124 = cljs.core.nth.call(null,vec__43119_43122,(1),null);
var db_changed_QMARK__43125 = (cljs.core.some_QMARK_.call(null,only_before_43123)) || (cljs.core.some_QMARK_.call(null,only_after_43124));
if(db_changed_QMARK__43125){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_43123);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_43124);
...
var map__43132 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__43132__$1 = ((((!((map__43132 == null)))?((((map__43132.cljs$lang$protocol_mask$partition0$ & (64))) || (map__43132.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43132):map__43132);
var db = cljs.core.get.call(null,map__43132__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__43132__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__43140 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__43140__$1 = ((((!((map__43140 == null)))?((((map__43140.cljs$lang$protocol_mask$partition0$ & (64))) || (map__43140.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43140):map__43140);
var coeffects = map__43140__$1;
var event = cljs.core.get.call(null,map__43140__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26162__auto___43143 = arguments.length;
var i__26163__auto___43144 = (0);
while(true){
if((i__26163__auto___43144 < len__26162__auto___43143)){
args__26169__auto__.push((arguments[i__26163__auto___43144]));

var G__43145 = (i__26163__auto___43144 + (1));
i__26163__auto___43144 = G__43145;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__26170__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq43142){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq43142));
});
...
var args__26169__auto__ = [];
var len__26162__auto___43151 = arguments.length;
var i__26163__auto___43152 = (0);
while(true){
if((i__26163__auto___43152 < len__26162__auto___43151)){
args__26169__auto__.push((arguments[i__26163__auto___43152]));

var G__43153 = (i__26163__auto___43152 + (1));
i__26163__auto___43152 = G__43153;
continue;
} else {
}
break;
...
var argseq__26170__auto__ = ((((2) < args__26169__auto__.length))?(new cljs.core.IndexedSeq(args__26169__auto__.slice((2)),(0),null)):null);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26170__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__43146_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__43147_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__43147_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq43148){
var G__43149 = cljs.core.first.call(null,seq43148);
var seq43148__$1 = cljs.core.next.call(null,seq43148);
var G__43150 = cljs.core.first.call(null,seq43148__$1);
var seq43148__$2 = cljs.core.next.call(null,seq43148__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__43149,G__43150,seq43148__$2);
});
