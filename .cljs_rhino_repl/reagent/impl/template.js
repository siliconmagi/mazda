...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25693__auto__,writer__25694__auto__,opt__25695__auto__){
return cljs.core._write.call(null,writer__25694__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__43489 = o;
(G__43489[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__25075__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__25075__auto__){
var and__25075__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__43498 = jsprops;
(G__43498["defaultValue"] = value);

(G__43498["onChange"] = ((function (G__43498,v,value,on_change){
return (function (p1__43495_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__43495_SHARP_);
});})(G__43498,v,value,on_change))
);

(G__43498["ref"] = ((function (G__43498,v,value,on_change){
return (function (p1__43496_SHARP_){
return (this$["cljsInputElement"] = p1__43496_SHARP_);
});})(G__43498,v,value,on_change))
);
...
var vec__43505 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__43505,(0),null);
var id = cljs.core.nth.call(null,vec__43505,(1),null);
var class$ = cljs.core.nth.call(null,vec__43505,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___43510 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___43510 == null)){
} else {
var key_43511 = temp__4661__auto___43510;
(jsprops["key"] = key_43511);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__43513 = (new reagent.impl.template.NativeWrapper());
(G__43513["name"] = c);
...
var len__26162__auto___43519 = arguments.length;
var i__26163__auto___43520 = (0);
while(true){
if((i__26163__auto___43520 < len__26162__auto___43519)){
args__26169__auto__.push((arguments[i__26163__auto___43520]));

var G__43521 = (i__26163__auto___43520 + (1));
i__26163__auto___43520 = G__43521;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26170__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq43517){
var G__43518 = cljs.core.first.call(null,seq43517);
var seq43517__$1 = cljs.core.next.call(null,seq43517);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__43518,seq43517__$1);
});
...
break;
default:
var G__43525 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__43525;
continue;
...
var n__26002__auto___43528 = a.length;
var i_43529 = (0);
while(true){
if((i_43529 < n__26002__auto___43528)){
(a[i_43529] = reagent.impl.template.as_element.call(null,(a[i_43529])));

var G__43530 = (i_43529 + (1));
i_43529 = G__43530;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__26002__auto___43531 = a.length;
var i_43532 = (0);
while(true){
if((i_43532 < n__26002__auto___43531)){
var val_43533 = (a[i_43532]);
if((cljs.core.vector_QMARK_.call(null,val_43533)) && ((reagent.impl.template.key_from_vec.call(null,val_43533) == null))){
(o["no-key"] = true);
} else {
}

(a[i_43532] = reagent.impl.template.as_element.call(null,val_43533));

var G__43534 = (i_43532 + (1));
i_43532 = G__43534;
continue;
} else {
}
...
var ctx = ({});
var vec__43538 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__43538,(0),null);
var derefed = cljs.core.nth.call(null,vec__43538,(1),null);
...
var G__43542 = (cljs.core.count.call(null,argv) - first_child);
switch (G__43542) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__43542){
